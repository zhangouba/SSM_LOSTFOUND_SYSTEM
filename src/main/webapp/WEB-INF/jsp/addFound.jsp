		...
		<div class="container">
			...
			<div class="add-lostAndFound">
				...
				<form class="animated wow slideInUp" data-wow-delay=".5s">
					...
					<div class="form-inline">
						...
						<div class="input-group animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
							...
							<input type="text" ng-model="entity.qq" class="form-control" placeholder="QQ号码" aria-describedby="basic-addon1">
										...
										<h5 class="animated wow slideInUp" data-wow-delay=".5s"><i class="glyphicon glyphicon-star"></i></h5>
					...
					<h5 class="animated wow slideInUp" data-wow-delay=".5s"><i class="glyphicon glyphicon-star"></i>必填  用户密码</h5>

					<div class="input-group animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
						<span class="input-group-addon" id="basic-addon1"><i class="glyphicon glyphicon-lock"></i></span>
						<input type="password" ng-model="entity.password" class="form-control" placeholder="密码" aria-describedby="basic-addon1" required="">
					</div>

					<div class="input-group animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
						<span class="input-group-addon" id="basic-addon1"><i class="glyphicon glyphicon-lock"></i></span>
						<input type="password" ng-model="confirmPwd2" class="form-control" placeholder="确认密码" aria-describedby="basic-addon1" required="">
					</div>
