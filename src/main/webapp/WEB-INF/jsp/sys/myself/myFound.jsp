...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
	<legend style="font-weight:bold">我的招领</legend>
</fieldset>
	<!-- 数据表格开始 -->
	...
	<form class="layui-form layui-row layui-col-space10"  lay-filter="dataFrm" id="dataFrm">
		<div class="layui-col-md12 layui-col-xs12">
			<div class="layui-row layui-col-space10">
				<div class="layui-col-md9 layui-col-xs7">
					<div class="layui-form-item magt3">
						<label class="layui-form-label">拾取物品:</label>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="foundPlace" class="layui-input" readonly="readonly"   placeholder="丢失地点">
						</div>
					</div>
					<div class="layui-form-item">
			...
			<div class="layui-form-item magb0" style="text-align: center;">
				<div class="layui-input-block">
					<button type="button" class="layui-btn layui-btn-danger layui-btn-sm layui-icon layui-icon-close" lay-filter="PASS"  lay-submit="">关闭</button>
				</div>
			</div>
		</div>
	</form>
...
<script type="text/javascript">
    ...
    layui.extend({
        ...
        tableIns=table.render({
            ...
            ,url:'${ctx}/myself/loadAllMyFound.action' //数据接口
            ...
            ,cols: [[   //列表数据
                ...
                ,{field:'infotitle', title:'拾取物品',align:'center',width:'200'}
                ,{field:'foundPlace', title:'拾取地点',align:'center',width:'180'}
                ,{field:'lostDATE', title:'拾取时间',align:'center',width:'180'}
        ...
        table.on('tool(UserTable)', function(obj){
            ...
            if(layEvent === 'edit'){ //编辑
                ...
                layer.confirm('真的删除这条记录吗', function(index){
                    //向服务端发送删除指令
                    $.post("${ctx}/myself/deleteMyFound.action",{id:data.id},function(res){
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
        ...
        function openUpdateUser(data){
            mainIndex=layer.open({
                ...
                success:function(index){
                    ...
                    <%--url="${ctx}/check/checkLost.action";--%>
        ...
        form.on("submit(doSubmit)",function(obj){
            //序列化表单数据
            var id=$("#id").val();
            $.post("${ctx}/myself/updateMyFound.action",{"id":id,"status":1},function(obj){
                layer.msg(obj.msg);
                //关闭弹出层
        ...
        function deleteBatch(){
            ...
            layer.confirm('真的删除选中的这些记录吗', function(index){
                //向服务端发送删除指令
                $.post("${ctx}/myself/deleteBatchMyFound.action",
                    params,
                    function(res){
                        layer.msg(res.msg);
                        //刷新数据 表格
