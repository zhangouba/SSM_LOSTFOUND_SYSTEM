...
public class ResultObj {
	 ...
	 * 审核失败
	 */
	public static final ResultObj CHECK_ERROR=new ResultObj(SysConstast.CODE_ERROR, SysConstast.CHECK_ERROR);

	/**
	 * 审核成功
	 */
	public static final ResultObj  CHECK_SUCCESS=new ResultObj(SysConstast.CODE_SUCCESS, SysConstast.CHECK_SUCCESS);
