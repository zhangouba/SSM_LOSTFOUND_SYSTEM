...
layui.use(['form','jquery',"layer"],function() {
    ...
    function getAll() {
        $.ajax({
            url: "/user/getSessionAll.action",
            type: "post",
            dataType: "json",
            async: false,
            success: function(resulk) {
                img =  resulk.data.img;
                pwd=resulk.data.pwd;
                realname=resulk.data.realname;
               // $("#imggs").attr("src",'/'+img);
              //  $("#lockUserName").html(realname);
              //  alert("end");
            }
        })
    }
    ...
    function lockPage(){
        ...
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                '<div class="admin-header-lock-img"><img id="imggs" src="/'+img+'" class="userAvatar"/></div>'+
                '<div class="admin-header-lock-name" id="lockUserName">'+realname+'</div>'+
                '<div class="input_btn">'+
