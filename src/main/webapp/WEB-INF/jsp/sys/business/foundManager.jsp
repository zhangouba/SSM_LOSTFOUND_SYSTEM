	...
	<form class="layui-form" method="post" id="searchFrm">
		<div class="layui-form-item">
			<div class="layui-inline">
				<label class="layui-form-label">招领物品:</label>
				...
				<div class="layui-row layui-col-space10">
					...
					<div class="layui-col-md3 layui-col-xs5">
						<div class="layui-upload-list thumbBox mag0 magt3" id="carimgDiv">
							<!-- 显示上传的图片 -->
							<img class="layui-upload-img thumbImg"  id="showCarImg" lay-filter="photo">
							<!-- 保存当前显示图片的地址 -->
	    ...
	    layui.extend({
			...
			//渲染数据表格
			 tableIns=table.render({
					...
					,url:'${ctx}/business/loadAllFound.action' //数据接口
			    ,title: '招领数据表'//数据导出来的标题
			    ...
			    ,cols: [[   //列表数据
			     {type: 'checkbox', fixed: 'left'},
                     ...
                     ,{field:'foundPlace', title:'丢失地点',align:'center',width:'180'}
			...
			$("#doSearch").click(function(){
				...
				tableIns.reload({
					url:"${ctx}/business/loadAllFound?"+params,
                    page:{curr:1}
				})
			});
		   ...
		   table.on('tool(UserTable)', function(obj){
				  ...
				  layer.confirm('真的删除这个记录吗', function(index){
				       //向服务端发送删除指令
				    $.post("${ctx}/business/deleteFound.action",{id:data.id},function(res){
				    	   layer.msg(res.msg);
				    	    //刷新数据 表格
							tableIns.reload();
				       })
			...
			function deleteBatch(){
			    ...
			    layer.confirm('真的删除选中的这些记录吗', function(index){
				       //向服务端发送删除指令
				       $.post("${ctx}/business/deleteBatchFound.action",
						   params,
						   function(res){
				    	   layer.msg(res.msg);
				    	    //刷新数据 表格
