...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
	<legend style="font-weight:bold">待审核寻物</legend>
</fieldset>
<!-- 数据表格开始 -->
...
<script type="text/javascript">
    ...
    layui.extend({
        ...
        tableIns=table.render({
            ...
            ,url:'${ctx}/check/loadAllLost.action' //数据接口
       ...
       // var url;
        ...
        form.on("submit(doSubmit)",function(obj){
            //序列化表单数据
            var id=$("#id").val();
            $.post("${ctx}/check/checkLostStatus.action",{"id":id,"status":1},function(obj){
                layer.msg(obj.msg);
                //关闭弹出层
        ...
        form.on("submit(PASS)",function(obj){
            //序列化表单数据
            var id=$("#id").val();
            $.post("${ctx}/check/checkLostStatus.action",{"id":id,"status":2},function(obj){
                layer.msg(obj.msg);
                //关闭弹出层
                layer.close(mainIndex)
                //刷新数据 表格
