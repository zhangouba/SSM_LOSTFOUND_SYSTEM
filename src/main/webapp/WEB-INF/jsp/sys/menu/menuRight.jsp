	...
	<script type="text/javascript">
	    ...
	    layui.extend({
			 ...
			 tableIns=table.render({
			    ...
			    ,cols: [[   //列表数据
			     {type: 'checkbox', fixed: 'left'}
			      ...
			      ,{field:'pid', title:'父节点ID',align:'center',width:'60'}
			      ...
			      ,{fixed: 'right', title:'操作', toolbar: '#menuBar', width:130,align:'center'}
			    ]]
			})
			//模糊查询
		   ...
		   table.on('tool(menuTable)', function(obj){
	           ...
	           if (obj.code>=0){
	             	 layer.msg("当前菜单有自子节点，请先删除子节点后重试");
	              }else {
					layer.confirm('真的删除菜单'+data.title+'么',function(index){
